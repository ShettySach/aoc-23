//Solution thanks to - https://github.com/tymscar/Advent-Of-Code/blob/master/2023/rust/src/day16/part2.rs
...
fn main() {
    let lines: Vec<Vec<_>> = include_str!("inputs.txt")
        .lines()
        .map(|line| line.chars().collect())
        .collect();

    println!("{}", get_max_energy_on_map(&lines).to_string());
}
